export const exportStartupsToCSV = (startups, filename = "CVC_Startups_List.csv") => {
  ...
  const rows = startups.map(s => [
    ...
    s.reachedStage || "",
    s.closeReason || "",
    s.status || s.investmentStatus || "1 ソーシング",
    s.investmentReachedStage || "",
    s.investmentCloseReason || "",
    s.revivalFeasibility || s.investmentRevivalFeasibility || "",
    s.revivalScenario || s.investmentRevivalScenario || "",
    s.foundedYear || "",
    s.location || "",
    s.website || "",
    s.tagline || "",

export const initialStartups = [
  ...
  },
  {
    ...
    revivalFeasibility: "A 高い",
    revivalScenario: "",
    status: "Invested / Portfolio (投資済・LP出資)",
    bizDevStatus: "Commercialized / Partnered (事業化・本導入・業務提携)",
  ...
  },
  {
    ...
    revivalScenario: "",
    status: "Review / Detailed Screening (詳細検討・定例)",
    bizDevStatus: "POC Consideration (POC検討・要件定義)",
  ...
  },
  {
    ...
    revivalFeasibility: "A 高い",
    revivalScenario: "",
    status: "Initial Contact (初回面談)",
    bizDevStatus: "Collaboration Review (協業検討中・ニーズ調査)",
